...
export const counterattacks = [
  {
    ...
    lane: "Left Wing",
    players: ["#11", "#9"],
    summary: "Fast break after turnover",
  },
  {
    id: "T-02",
    time: "01:12–01:17",
    ...
    lane: "Center",
    players: ["#8", "#10", "#7"],
    summary: "Direct vertical transition",
  },
  {
    id: "T-03",
    time: "01:44–01:49",
  ...
  },
  {
    ...
    lane: "Center",
    players: ["#6", "#9"],
    summary: "Counter through midfield",
  },
];
...
export const predictive = [
  { frame: 30, team: 0, pass_success: 85.4, loss_risk: 15.2, danger_prob: 35.5 },
  { frame: 60, team: 0, pass_success: 78.1, loss_risk: 22.4, danger_prob: 42.1 },
  { frame: 90, team: 1, pass_success: 65.0, loss_risk: 45.8, danger_prob: 12.0 },
  { frame: 120, team: 1, pass_success: 92.5, loss_risk: 8.5, danger_prob: 68.9 },
  { frame: 150, team: 0, pass_success: 71.3, loss_risk: 28.7, danger_prob: 88.2 },
];
