...
import { CircleDot, Route, Grid3x3, Users, Zap, BrainCircuit } from "lucide-react";
  ...
  return (
    <section className="mx-auto mt-10 max-w-7xl px-6">
      <div className="mb-4">
        ...
        <p className="text-sm text-muted-foreground">Six AI-generated layers of match intelligence.</p>
      </div>
      <Tabs defaultValue="possession">
        <TabsList className="flex h-auto w-full flex-wrap justify-start gap-1 bg-secondary/50 p-1">
          ...
          <TabsTrigger value="predictive" className="gap-1.5"><BrainCircuit className="h-3.5 w-3.5" /> Predictive</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="predictive" className="mt-5"><PredictiveTab /></TabsContent>
      </Tabs>
    </section>
  );
}
